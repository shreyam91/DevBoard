    ...
    <div className="flex min-h-screen flex-col selection:bg-accent-blue/20 text-slate-900 relative overflow-hidden">
      ...
      <main className="relative z-10 flex-1 px-6 py-6 md:px-12 max-w-[1200px] mx-auto w-full grid grid-cols-1 lg:grid-cols-[1fr_1fr] gap-16 lg:gap-24 items-start">
        ...
        <div className="flex flex-col">
          ...
          >
            Whether you have a question about our application or just want to
            share feedback—our engineering team is ready to help.
          </motion.p>
          ...
          >
            <div>
              <h3 className="text-[14px] font-semibold text-slate-900 uppercase tracking-widest mb-4">
                Resources
              </h3>
              <div className="flex flex-col gap-3">
                <Link
                  href="/privacy"
                  className="text-[15px] font-medium text-slate-600 hover:text-slate-900 underline underline-offset-4 decoration-slate-300"
                >
                  Privacy Policy
                </Link>
                <Link
        ...
        <div className="relative flex items-center justify-center mt-20">
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.3 }}
            className="w-full max-w-lg p-10 shadow-slate-200/40"
          >
            ...
            <p className="text-slate-600 leading-relaxed mb-10">
              Have questions about DevBoard or want to contribute? We&apos;d
            ...
            <div className="flex flex-col gap-5">
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-500">shreyam91183@gmail.com</p>
                  </div>
                </div>
              ...
              <a
                href="https://github.com/shreyam91/DevBoard"
                target="_blank"
