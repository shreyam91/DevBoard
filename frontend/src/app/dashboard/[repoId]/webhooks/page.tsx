    ...
    <div className="flex flex-col h-full overflow-hidden bg-transparent">
      ...
      <header className="h-[64px] bg-white/60 backdrop-blur-md border-b border-slate-200 flex items-center justify-between px-6 shrink-0 z-10">
        <div className="flex items-center gap-4">
          <h2 className="text-[16px] font-bold text-slate-900 tracking-tight">Webhooks</h2>
          <div className="w-px h-4 bg-slate-300"></div>
          <span className="text-[13px] font-medium text-slate-500">Manage integrations for {repoId}</span>
        </div>

        <button className="h-[36px] px-4 bg-slate-900 hover:bg-slate-800 shadow-sm rounded-lg flex items-center gap-2 transition-all group">
