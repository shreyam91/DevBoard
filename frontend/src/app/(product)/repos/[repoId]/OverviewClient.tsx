  ...
  return (
    <>
      <div className="flex relative min-w-0 w-full">
        <div className="flex-1 max-w-[1000px] mx-auto p-6 md:p-8 min-w-0">
          ...
          {latestConflict && !query && (
            <div className="mb-8 bg-accent-red/10 border border-accent-red/20 rounded-xl p-4 flex items-center justify-between shadow-sm">
              ...
              <a href={`/repos/${repoId}/conflicts`} className="text-[13px] text-white bg-accent-red hover:bg-accent-red/90 px-4 py-1.5 rounded-lg font-semibold transition-colors shadow-sm">
                Review Conflict
              </a>
            </div>
          )}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            ...
            <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm hover:shadow-md hover:border-slate-300 transition-all group cursor-pointer" onClick={() => window.location.href = `/repos/${repoId}/pending`}>
              <div className="flex items-center gap-3 mb-4">
