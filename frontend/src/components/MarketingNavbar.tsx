...
export default function MarketingNavbar({ isSignedIn }: { isSignedIn: boolean }) {
  ...
  return (
    <nav className="sticky top-0 z-50 flex h-[56px] items-center justify-between border-b border-[rgba(255,255,255,0.08)] bg-background/80 backdrop-blur-md px-6 md:px-8">
      {/* Left: Logo */}
      ...
      <div className="hidden items-center gap-6 md:flex">
        ...
        <Link href="/about" className="text-[13px] text-[rgba(255,255,255,0.5)] transition-colors hover:text-[rgba(255,255,255,0.85)]">
          About
        </Link>
        <Link href="/contact" className="text-[13px] text-[rgba(255,255,255,0.5)] transition-colors hover:text-[rgba(255,255,255,0.85)]">
          Contact
        </Link>
      ...
      {isOpen && (
        <div className="absolute left-0 right-0 top-[56px] flex flex-col border-b border-[rgba(255,255,255,0.08)] bg-background/95 backdrop-blur-md p-4 md:hidden shadow-lg">
          <div className="flex flex-col gap-4">
            ...
            <Link href="/about" className="text-[14px] text-[rgba(255,255,255,0.7)]" onClick={() => setIsOpen(false)}>
              About
            </Link>
            <Link href="/contact" className="text-[14px] text-[rgba(255,255,255,0.7)]" onClick={() => setIsOpen(false)}>
              Contact
            </Link>
